...
import 'z_plantilla2_model.dart';
export 'z_plantilla2_model.dart';

class ZPlantilla2Widget extends StatefulWidget {
  const ZPlantilla2Widget({super.key});

  static String routeName = 'zPlantilla2';
  static String routePath = '/zPlantilla2';

  @override
  State<ZPlantilla2Widget> createState() => _ZPlantilla2WidgetState();
}

class _ZPlantilla2WidgetState extends State<ZPlantilla2Widget>
    with TickerProviderStateMixin {
  late ZPlantilla2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ZPlantilla2Model());
