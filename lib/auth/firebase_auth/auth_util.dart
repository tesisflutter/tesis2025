...
DocumentReference? get currentUserReference =>
    loggedIn ? GoogleUserRecord.collection.doc(currentUser!.uid) : null;

GoogleUserRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : GoogleUserRecord.getDocument(GoogleUserRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
