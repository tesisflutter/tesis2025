...
import 'market_modificar_publicacion_model.dart';
export 'market_modificar_publicacion_model.dart';

class MarketModificarPublicacionWidget extends StatefulWidget {
  const MarketModificarPublicacionWidget({
    super.key,
    required this.docPublicacion,
  });

  final PublicacionMarketRecord? docPublicacion;

  static String routeName = 'Market_ModificarPublicacion';
  static String routePath = '/marketModificarPublicacion';

  @override
  State<MarketModificarPublicacionWidget> createState() =>
      _MarketModificarPublicacionWidgetState();
}

class _MarketModificarPublicacionWidgetState
    extends State<MarketModificarPublicacionWidget> {
  late MarketModificarPublicacionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MarketModificarPublicacionModel());
    ...
    _model.txtFieldTituloTextController ??=
        TextEditingController(text: widget.docPublicacion?.titulo);
    _model.txtFieldTituloFocusNode ??= FocusNode();

    _model.txtFieldCiudadTextController ??=
        TextEditingController(text: widget.docPublicacion?.ciudad);
    _model.txtFieldCiudadFocusNode ??= FocusNode();

    _model.txtFieldContactoTextController ??=
        TextEditingController(text: widget.docPublicacion?.telefonoContacto);
    _model.txtFieldContactoFocusNode ??= FocusNode();

    _model.txtFieldPrecioTextController ??=
        TextEditingController(text: widget.docPublicacion?.precio.toString());
    _model.txtFieldPrecioFocusNode ??= FocusNode();

    _model.txtFieldDescripcionTextController ??=
        TextEditingController(text: widget.docPublicacion?.descripcion);
                                              ...
                                              builder: (context) {
                                                ...
                                                return Container(
                                                  ...
                                                  child: CarouselSlider.builder(
                                                    itemCount:
                                                        listaFotosPublicacion
                                                            .length,
                                                    itemBuilder: (context,
                                                        listaFotosPublicacionIndex,
                                                        _) {
                                                      final listaFotosPublicacionItem =
                                                          listaFotosPublicacion[
                                                              listaFotosPublicacionIndex];
                                                      return InkWell(
                                                        splashColor:
                                                          ...
                                                          child: Padding(
                                                            ...
                                                            child:
                                                              ...
                                                              controller: _model
                                                                  ...
                                                                  FormFieldController<
                                                                      String>(
                                                                _model.dropDownProvinciaValue ??= widget
                                                                    .docPublicacion
                                                                    ?.provincia,
                                                              ),
                                                              options: [
                                ...
                                Flexible(
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      await widget.docPublicacion!.reference
                                          .update({
                        ...
                        SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              ...
                              if (widget.docPublicacion?.categoria !=
                                  'Equinos')
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 10.0, 0.0, 0.0),
                                            ...
                                            await showDialog(
                                              ...
                                              builder: (alertDialogContext) {
                                                return AlertDialog(
                                                  ...
                                                  content: Text(
                                                      'Es necesario subir al menos 1 foto en la publicación.'),
                                                  actions: [
                                                    TextButton(
                                                      onPressed: () =>
                                                          Navigator.pop(
                                          ...
                                          await showDialog(
                                            ...
                                            builder: (alertDialogContext) {
                                              return AlertDialog(
                                                ...
                                                content: Text(
                                                    'Sólo se pueden subir hasta 10 fotos por publicación.'),
                                                actions: [
                                                  TextButton(
                                                    onPressed: () =>
                                                        Navigator.pop(
