...
class NuevaCuentaWidget extends StatefulWidget {
  ...
  static String routePath = '/nuevaCuenta';
...
class _NuevaCuentaWidgetState extends State<NuevaCuentaWidget> {
  ...
  void initState() {
    ...
    _model.txtFieldApellidoTextController ??= TextEditingController();
    _model.txtFieldApellidoFocusNode ??= FocusNode();
    ...
    _model.txtFieldTelefonoTextController ??= TextEditingController();
    _model.txtFieldTelefonoFocusNode ??= FocusNode();

    _model.txtFieldContraseniaTextController ??= TextEditingController();
    _model.txtFieldContraseniaFocusNode ??= FocusNode();

    _model.txtFieldContrasenia2TextController ??= TextEditingController();
    _model.txtFieldContrasenia2FocusNode ??= FocusNode();
  }
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.txtFieldNombreTextController,
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.txtFieldApellidoTextController,
                                    focusNode: _model.txtFieldApellidoFocusNode,
                                    autofocus: false,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      labelText: 'Apellido...',
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.txtFieldCorreoTextController,
                                    focusNode: _model.txtFieldCorreoFocusNode,
                                    autofocus: false,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      labelText: 'Correo...',
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.txtFieldTelefonoTextController,
                                    focusNode: _model.txtFieldTelefonoFocusNode,
                                    autofocus: false,
                                    obscureText: false,
                                    decoration: InputDecoration(
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    focusNode:
                                        _model.txtFieldContraseniaFocusNode,
                                    autofocus: false,
                                    obscureText:
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    controller: _model
                                        .txtFieldContrasenia2TextController,
                                    focusNode:
                                        _model.txtFieldContrasenia2FocusNode,
                                    autofocus: false,
                                    obscureText:
                                        !_model.txtFieldContrasenia2Visibility,
                                    decoration: InputDecoration(
                                      ...
                                      suffixIcon: InkWell(
                                        onTap: () => safeSetState(
                                          () => _model
                                                  .txtFieldContrasenia2Visibility =
                                              !_model
                                                  .txtFieldContrasenia2Visibility,
                                        ),
                                        focusNode:
                      ...
                      onPressed: () async {
                        await showModalBottomSheet(
                          ...
                          builder: (context) {
                            ...
                            () => _model.outputFotoPerfilSubidaPath = value));

                        if (_model.outputFotoPerfilSubidaPath != null &&
                            _model.outputFotoPerfilSubidaPath != '') {
                          _model.fotoSubidaPath =
                              _model.outputFotoPerfilSubidaPath;
                          safeSetState(() {});
                        }
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: _model.fotoSubidaPath != null && _model.fotoSubidaPath!.isNotEmpty
                          ? DecorationImage(
                        fit: BoxFit.cover,
                        image: Image.network(_model.fotoSubidaPath!).image,
                      )
                          : null, // No image if path is null or empty
                    ),
                  ),
                ],
              ),
                ...
                children: [
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      ...
                      if (_model.txtFieldContraseniaTextController.text !=
                          _model.txtFieldContrasenia2TextController.text) {
                        ...
                        await showDialog(
                          ...
                          builder: (alertDialogContext) {
                            return AlertDialog(
                              ...
                              content: Text(
                                  'Se le ha enviado un correo a su casilla. Por favor, verifique su correo antes de ingresar.'),
                              actions: [
                                TextButton(
                                  onPressed: () =>
                        ...
                        await showDialog(
                          ...
                          builder: (alertDialogContext) {
                            return AlertDialog(
                              ...
                              content: Text(
                                  'No se ha subido ninguna foto de perfil.'),
                              actions: [
                                TextButton(
                                  onPressed: () =>
                                      Navigator.pop(alertDialogContext),
