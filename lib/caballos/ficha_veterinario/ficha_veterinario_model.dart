...
import '/index.dart';
import 'ficha_veterinario_widget.dart' show FichaVeterinarioWidget;
import 'package:flutter/material.dart';

class FichaVeterinarioModel extends FlutterFlowModel<FichaVeterinarioWidget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in btn_Registrar widget.
  UsuarioRecord? queryUsuarioActual;
