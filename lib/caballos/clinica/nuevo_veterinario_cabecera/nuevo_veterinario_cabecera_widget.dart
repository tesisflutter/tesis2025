...
import 'nuevo_veterinario_cabecera_model.dart';
export 'nuevo_veterinario_cabecera_model.dart';

class NuevoVeterinarioCabeceraWidget extends StatefulWidget {
  const NuevoVeterinarioCabeceraWidget({
    super.key,
  ...
  static String routeName = 'Nuevo_Veterinario_Cabecera';
  static String routePath = '/nuevoVeterinarioCabecera';

  @override
  State<NuevoVeterinarioCabeceraWidget> createState() =>
      _NuevoVeterinarioCabeceraWidgetState();
}

class _NuevoVeterinarioCabeceraWidgetState
    extends State<NuevoVeterinarioCabeceraWidget> {
  late NuevoVeterinarioCabeceraModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NuevoVeterinarioCabeceraModel());
        ...
        appBar: responsiveVisibility(
          ...
          desktop: false,
            ...
            ? AppBar(
                ...
                title: Text(
                  'Registrar Veterinario de cabecera',
                      ...
                      onPressed: () async {
                        ...
                        await MedicoVeterinarioRecord.collection
                            ...
                            .set(createMedicoVeterinarioRecordData(
                              iDMedicoVeterinario: _model.queryUltimoVeteCreado!
                                      .iDMedicoVeterinario +
                                  1,
                              nombre:
                                  _model.txtFieldNombreVeteTextController.text,
                              apellido: _model
                                  .txtFieldApellidoVeteTextController.text,
                              correo:
                                  _model.txtFieldVeteCorreoTextController.text,
                              telefono: int.tryParse(_model
                                  .txtFieldVeteContactoTextController.text),
                              numeroMatricula: int.tryParse(_model
                                  .txtFieldNroMatriculaTextController.text),
                        ...
                        FFAppState().idVeterinarioCabecera =
                            _model.queryUltimoVeteCreado!.iDMedicoVeterinario +
                                1;
                        safeSetState(() {});
