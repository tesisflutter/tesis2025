...
import 'componente_agendar_evento_widget.dart'
    show ComponenteAgendarEventoWidget;
import 'package:flutter/material.dart';

class ComponenteAgendarEventoModel
    extends FlutterFlowModel<ComponenteAgendarEventoWidget> {
  ...
  // State field(s) for chk_1semana widget.
  bool? chk1semanaValue;
  // State field(s) for chk_1dia widget.
  bool? chk1diaValue;
  // State field(s) for chk_1hora widget.
  bool? chk1horaValue;
  // Stores action output result for [Firestore Query - Query a collection] action in Button widget.
  int? cuentaDocumentosEvento;
  // Stores action output result for [Backend Call - Create Document] action in Button widget.
  EventoCalendarioRecord? eventoCreado;
